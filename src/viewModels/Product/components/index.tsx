        ...
        <>
            <View className="pb-5 items-start">
                <TouchableOpacity
                    ...
                    <Text
                        className="text-base text-purple-base">
                        Voltar
                    </Text>
                </TouchableOpacity>
            </View>
            ...
            <View className="bg-background py-8">
                ...
                <View className="flex-row justify-between items-baseline mb-4">
                    <Text className="text-xl font-bold text-gray-800 max-w-[65%]">
                        {productDetails.name}
                    </Text>
                ...
                <View className="flex-row items-center bg-blue-light p-3 rounded-lg mb-4">
                    ...
                    <Text className="text-sm text-gray-600 flex-1 ml-5">
                        <Text className="font-bold">
                            {productDetails.views} Pessoas </Text>
                ...
                <View className="mb-6">
                    <Text className="text-base font-bold text-gray-80">Categoria </Text>
